...
public class Main {
    ...
    * 生成表达式
    * */
    private static String expression(int r){
    ...
    private static String bolan(String result){
     ...
     * @return
     */
    private static int yuefen(int num1,int num2){
        while(true)
        {
    ...
    private static String huajian(int integer,int num1,int num2){
        //num1是分子，num2是分母
        String result=new String();
